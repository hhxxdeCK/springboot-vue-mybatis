                    ...
                    <el-col :span="24">
                        <div class="grid-content bg-purple-light">
                            <el-row :gutter="20">
                                ...
                                <el-col :span="6">
                                    <div style="align:center" class="grid-content bg-purple-light">
                                        <el-button @click="searchPerson" type="primary" icon="el-icon-search">搜索
                                        </el-button>
                                    </div>
                                </el-col>
                                <el-col :span="6">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button size="mini" type="danger"
                                       @click="removeUser(scope.$index, scope.row)">删除
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
